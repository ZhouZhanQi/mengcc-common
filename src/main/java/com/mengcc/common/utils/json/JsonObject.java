...
public class JsonObject implements Iterable<Map.Entry<String, Object>>, Serializable {
    ...
    public Integer getInteger(String key) {
        Objects.requireNonNull(key);
        return NumberConvertHelper.toInteger((Number) map.get(key));
    }
    ...
    public Long getLong(String key) {
        Objects.requireNonNull(key);
        return NumberConvertHelper.toLong((Number) map.get(key));
    }
    ...
    public Double getDouble(String key) {
        Objects.requireNonNull(key);
        return NumberConvertHelper.toDouble((Number) map.get(key));
    }
    ...
    public Float getFloat(String key) {
        Objects.requireNonNull(key);
        return NumberConvertHelper.toFloat((Number) map.get(key));
    }
