...
package com.mengcc.common.utils.json;



import com.mengcc.common.helper.NumberConvertHelper;
...
public class JsonArray implements Iterable<Object>, Serializable {
    ...
    public Integer getInteger(int pos) {
        return NumberConvertHelper.toInteger((Number) list.get(pos));
    }
    ...
    public Long getLong(int pos) {
        return NumberConvertHelper.toLong((Number) list.get(pos));
    }
    ...
    public Double getDouble(int pos) {
        return NumberConvertHelper.toDouble((Number) list.get(pos));
    }
    ...
    public Float getFloat(int pos) {
        return NumberConvertHelper.toFloat((Number) list.get(pos));
    }
