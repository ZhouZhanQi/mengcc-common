...
public final class HttpClientUtils {
     ...
     * @return
     */
    public static byte[] doFileGet(String url) {
     ...
     * @return
     */
    public static byte[] doFileGet(String url, Map<String, String> queryParams) {
        return doFileGet(url, queryParams, null);
    }
    /**
     * 发送一个http get请求
     *
     ...
     * @return
     */
    public static byte[] doFileGet(String url, Map<String, String> queryParams, Map<String, String> headers) {
        return doFileGet(url, queryParams, headers, client);
    }
     ...
     * @return
     */
    public static byte[] doFileGet(String url, Map<String, String> queryParams, Map<String, String> headers, CloseableHttpClient httpClient) {
        return resp2bytes(get(url, queryParams, headers, httpClient));
    }
    ...
    public static String doJsonPost(String url, String body) {
        ...
        headers.put("Content-Type", "application/com.doyd.common.core.json;charset=utf-8");
        return doPost(url, body, headers);
    }

    public static String doJsonPost(String url, Map<String, String> queryParam, String body) {
        Map<String, String> headers = new HashMap<>(2);
        headers.put("Content-Type", "application/com.doyd.common.core.json;charset=utf-8");
        return doPost(url, queryParam, body, headers, 30000);
    }
